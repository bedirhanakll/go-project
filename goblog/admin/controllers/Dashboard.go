...
func (dashboard Dashboard) Index(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	...
	}).ParseFiles(helpers.Include("dashboard/blogekle/list")...)
	if err != nil {
		fmt.Println(err)
		return
	}
...
func (dashboard Dashboard) NewItem(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	...
	view, err := template.ParseFiles(helpers.Include("dashboard/blogekle/add")...)
	if err != nil {
		fmt.Println(err)
		return
	}
...
func (dashboard Dashboard) Edit(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	...
	view, err := template.ParseFiles(helpers.Include("dashboard/blogekle/edit")...)
	if err != nil {
		fmt.Println(err)
		return
	}
